...
ua=fk.UserAgent()
se = requests.session()   
se.verify=False                                 #跳过https证书校验？不设置的会提示https ssl错误
...
u1=r'https://login.wx.qq.com/jslogin?appid=wx782c26e4c19acffb&redirect_uri=
                        https%3A%2F%2Fwx.qq.com%2Fcgi-bin%2Fmmwebwx-bin%2Fwebwxnewloginpage&un=new&lang=zh_CN&_=1528792097402'
print('u1=',u1)
r1=se.get(u1)
re1=re.compile('"(.*?)"')
